...
class ReportMatrix(ReportContainer):
    ...
    def combined_result_list(self, classname: str, casename: str):
        """
        Combine the result of all instances of the given case
        :param classname:
        :param casename:
        :return:
        """
...
class HTMLMatrix:
    ...
    def __str__(self) -> str:
        loader = self.matrix.loader_factory.get_loader()
        env = Environment(
            loader=loader,
...
class HtmlReportMatrix(ReportMatrix):
    ...
    def short_outcome(self, outcome: CaseResult) -> "Literal['/', 's', 'f', 'F', '%', 'X', 'U', '?']":
        if outcome == CaseResult.PASSED:
            return "/"
